        ...
        <div className="auth-links">
          {mode === "signin" && (
            <>
              ...
              <button type="button" onClick={() => { setMode("reset"); setError(""); setResetSent(false); }}>Forgot password?</button>
            </>
          )}
          {mode === "signup" && (
          ...
          {mode === "reset" && (
            <button type="button" onClick={() => { setMode("signin"); setError(""); setResetSent(false); }}>Back to sign in</button>
          )}
        </div>
      </form>
    </div>
